 ...
 */
public class AshwinSceneView extends View {
    ...
    public AshwinSceneView(Context context) {
        super(context);

    }

    public AshwinSceneView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AshwinSceneView(Context context, AttributeSet attrs, int defStyleAttr) {
