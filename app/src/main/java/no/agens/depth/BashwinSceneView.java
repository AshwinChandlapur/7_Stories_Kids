 ...
 */
public class BashwinSceneView extends View {
    ...
    public BashwinSceneView(Context context) {
        super(context);

    }

    public BashwinSceneView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BashwinSceneView(Context context, AttributeSet attrs, int defStyleAttr) {
