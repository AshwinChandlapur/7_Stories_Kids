 ...
 */
public class DashwinSceneView extends View {
    ...
    public DashwinSceneView(Context context) {
        super(context);

    }

    public DashwinSceneView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DashwinSceneView(Context context, AttributeSet attrs, int defStyleAttr) {
