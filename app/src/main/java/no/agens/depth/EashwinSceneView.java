 ...
 */
public class EashwinSceneView extends View {
    ...
    public EashwinSceneView(Context context) {
        super(context);

    }

    public EashwinSceneView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EashwinSceneView(Context context, AttributeSet attrs, int defStyleAttr) {
