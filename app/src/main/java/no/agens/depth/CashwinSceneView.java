 ...
 */
public class CashwinSceneView extends View {
    ...
    public CashwinSceneView(Context context) {
        super(context);

    }

    public CashwinSceneView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CashwinSceneView(Context context, AttributeSet attrs, int defStyleAttr) {
